...
import com.klui.refresh.internal.ArrowDrawable;
import com.klui.refresh.internal.InternalClassics;
import com.klui.refresh.internal.ProgressDrawable;
...
public class ClassicsFooter extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public ClassicsFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lpProgress.rightMargin =
                ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlDrawableMarginRight, density.dip2px(20));
        ...
        lpProgress.height =
                ta.getLayoutDimension(R.styleable.ClassicsFooter_srlDrawableProgressSize, lpProgress.height);
        ...
        mSpinnerStyle = SpinnerStyle.values()[ta.getInt(R.styleable.ClassicsFooter_srlClassicsSpinnerStyle,
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlTextSizeTitle, DensityUtil.dp2px(16)));
        } else {
