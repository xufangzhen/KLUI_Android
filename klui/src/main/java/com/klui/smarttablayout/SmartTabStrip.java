...
public class SmartTabStrip extends LinearLayout {
    ...
    private com.klui.smarttablayout.SmartTabIndicationInterpolator indicationInterpolator;
    ...
    SmartTabStrip(Context context, AttributeSet attrs) {
        ...
        int indicationInterpolatorId = com.klui.smarttablayout.SmartTabIndicationInterpolator.ID_SMART;
