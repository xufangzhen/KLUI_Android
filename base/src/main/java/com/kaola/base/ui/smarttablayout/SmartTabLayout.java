...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    private boolean mIsNeedBold;
    private int mBoldTextViewId;

    public void setNeedBold(boolean needBold, int id) {
        mIsNeedBold = needBold;
        mBoldTextViewId = id;
    }
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabBackgroundResId =
                a.getResourceId(R.styleable.stl_SmartTabLayout_stl_defaultTabBackground, tabBackgroundResId);
        ...
        textHorizontalPadding =
                a.getDimensionPixelSize(R.styleable.stl_SmartTabLayout_stl_defaultTabTextHorizontalPadding,
                        textHorizontalPadding);
        textMinWidth = a.getDimensionPixelSize(R.styleable.stl_SmartTabLayout_stl_defaultTabTextMinWidth, textMinWidth);
        customTabLayoutId =
                a.getResourceId(R.styleable.stl_SmartTabLayout_stl_customTabTextLayoutId, customTabLayoutId);
        customTabTextViewId =
                a.getResourceId(R.styleable.stl_SmartTabLayout_stl_customTabTextViewId, customTabTextViewId);
     ...
     *
     * @param interpolator {@link com.kaola.base.ui.smarttablayout.SmartTabIndicationInterpolator}
     */
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mIsNeedBold) {
                TextPaint tp = ((TextView) tabView.findViewById(mBoldTextViewId)).getPaint();
    ...
    private void scrollToTab(int tabIndex, int positionOffset) {
        ...
        int x = isLayoutRtl ? start + startMargin - positionOffset - getWidth() + Utils.getPaddingHorizontally(this)
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0, size = tabStrip.getChildCount(); i < size; i++) {
                ...
                if (mIsNeedBold) {
                    TextPaint tp = ((TextView) tabStrip.getChildAt(i).findViewById(mBoldTextViewId)).getPaint();
                    tp.setFakeBoldText(position == i);
                }
            }
